...
public class OwnerController {
    ...
    public ResponseEntity<OwnerDTO> create(@RequestBody OwnerDTO ownerDTO){
        ...
        if(resDto==null) return ResponseEntity.badRequest().build();
    ...
    public ResponseEntity<List<BonsaiSimplifieDTO>> getBonsaisByOwnerID(@PathVariable UUID id){
        ...
        if(!bonsais.isPresent()) return ResponseEntity.notFound().build();
    ...
    public void deleteOwner(@PathVariable UUID ownerId){
